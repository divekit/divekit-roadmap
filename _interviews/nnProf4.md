...
4. Erfolgt die Kontrolle der Aufgaben bisher schon teil-automatisiert oder digital-unterstützt?
   ...
   4.1.2. Gibt es etwas, dass Sie weiterhin ausschließlich manuell machen möchten, obwohl es automatisierbar wäre?
5. Welche möglichen Anwendungszwecke könnte eine digitale Toolunterstützung für Sie übernehmen?

   5.1. Wären Sie daran interessiert, es in Ihren Veranstaltungen zu verwenden?
...
6. Sehen Sie mögliche Bedenken, Gefahren oder Probleme, die durch den Einsatz vom DiveKit oder ähnlicher Software entstehen könnte?
7. Glauben Sie, dass Ihre Kolleginnen und Kollegen auch Interesse an einer Software wie dem DiveKit haben könnten?
...
* Systemintegrationsaufgaben in höheren Semestern:
  ...
  * Datensicherung
  * Parser-Integration
  * Einmal eine gesamte Pipeline zusammenbauen im Semester

#### Frage 2: Welche digitalen Lernmethoden kommen bei Ihnen bereits zum Einsatz? [00:07:25]
* Infrastruktur: Ilias, Big Blue Button, Livestream mit Matrix-Server
...
**Umfang [00:26:37]:** 
* Kollege hat gesamte Veranstaltung mit dem individualisierten Lerntool gemacht:
...
**Digitalen Toolunterstützung [00:27:51]:**
* wird bereits gemacht
* möchte lieber seine eigenen Scripte verwenden, anstatt einem fremden Tool
...
* Feedback zu Umsetzungen vom Visitor Pattern gerne visualisiert als Graph
* War bisher schlecht umsetzbar

**Weiterhin ausschließlich manuell machen, obwohl automatisierbar [00:34:59]:**
* Wenn Noten verbenem werden sollen
* Professsor mag Benoten grundsätzlich nicht gerne
* Im Zweifel gerne mit Studierenden über Note diskutieren
* Wenn jemanand etwas verstanden hat, kann er darüber reden

#### Frage 5: Welche möglichen Anwendungszwecke könnte eine digitale Toolunterstützung für Sie übernehmen? [00:36:22]
* Codewars: Wettbewerb, bei dem man zu bestimmten Aufgaben Lösungen entwickelt und diese gegen Test laufen lässt, Punkte sammeln, Schweregrad frei bestimmbar
* Mag nicht den elitären Charakter
...
#### Frage 6: Sehen Sie mögliche Bedenken, Gefahren oder Probleme, die durch den Einsatz vom DiveKit oder ähnlicher Software entstehen könnte? [00:43:16]
* Datenschutz
...
#### Frage 7: Glauben Sie, dass Ihre Kolleginnen und Kollegen auch Interesse an einer Software wie dem DiveKit haben könnten? [00:46:05]
* Professor baut solche Sachen gerne für sich selber, kann sich aber vorstellen, dass anderere Lehrende Interesse am Tool haben könnten

#### Frage 8: Haben Sie sonstige Anmerkungen / Hinweise? Möchten Sie noch etwas Ergänzen? [00:49:04]
* Software muss Open Sourcen sein, damit sie überhaupt in Frage käme (00:48:06)
